...
def perform_feature_selection(X, y, method='mutual_info', k=None):
    ...
    if method == 'mutual_info':
        ...
        # Ensure features are non-negative for chi-squared test
...
def main():
    ...
    # Feature selection
    selector, selected_features, feature_scores = perform_feature_selection(X, y_encoded, method='mutual_info', k=50)
